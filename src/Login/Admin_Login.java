...
public class Admin_Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jAUdmin = new javax.swing.JTextField();
        ...
        jAUdmin.setFont(new java.awt.Font("Tahoma", 0, 60)); // NOI18N
        jAUdmin.setDoubleBuffered(true);
        jAUdmin.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jAUdminActionPerformed(evt);
            }
        });
        jPanel1.add(jAUdmin, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 260, 520, -1));
    ...
    private void jAUdminActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jAUdminActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_jAUdminActionPerformed
    ...
    private void btn_loginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_loginActionPerformed
        user u = new user();
        int response = u.Login(jAUdmin.getText(), jPass.getText());
        ...
        if (response == 1){ //Admin
            ...
            //Student account
            JOptionPane.showMessageDialog(this, "Student Account", "Message", JOptionPane.WARNING_MESSAGE);
        }else if (response == 3){
            //Inactive Account
            JOptionPane.showMessageDialog(this, "Account Inactive! Please contact Admin", "Message", JOptionPane.WARNING_MESSAGE);
        }else if (response == 4){
    ...
    private javax.swing.JTextField jAUdmin;
